...
path_DefenseFolder = os.path.join(rootdir, sys.argv[1])
path_AttackFolder = os.path.join(rootdir, sys.argv[2])
...
def did_this_attack_succeed(attackFilename, defenseFilename):
    ...
    pobj = subprocess.Popen(
        ['python2', '../repy.py', '--stop=Repy_stop_this', '../restrictions.default', '../encasementlib.r2py', defenseFilename,
